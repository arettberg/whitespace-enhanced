...
This is a fork of atom's built-in [Whitespace](https://github.com/atom/whitespace) package, with one added feature: an option to only trim whitespace from lines that have been modified since the last commit (git only).
